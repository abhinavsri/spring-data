...
public class GoalRepositoryIntegrationTest {
    ...
    @Test
    public void findOne() {
        User stephen = userRepository.findOne(2L);
        ...
        assertThat(stephen.getUsername(), is("akash@fintechlabs.in"));
